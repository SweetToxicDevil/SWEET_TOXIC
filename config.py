...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/SweetToxicDevil/SWEET_TOXIC")
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "main")

GIT_TOKEN = getenv("GIT_TOKEN", None)

SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/SweetToxicHeroku_CC")
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/SweetToxicSupport")
